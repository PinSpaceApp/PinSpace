...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          const TwinklingBackground(), // Animated background
          Center(
            child: SingleChildScrollView(
               ...
               child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      const AnimatedLogo(size: 150), // Logo
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                          color: Colors.white, fontSize: 18, fontWeight: FontWeight.w500,
                           shadows: [ Shadow(blurRadius: 4.0, color: Colors.black54, offset: Offset(1,1)) ]
                        ),
                      ),
                      ...
                      _isLoading
                       ...
                       Row(
                         mainAxisAlignment: MainAxisAlignment.center,
                         children: [
                           IconButton( icon: const Icon(Icons.android_rounded), iconSize: 40, color: Colors.white, tooltip: 'Sign in with Google', onPressed: _isLoading ? null : () => _handleSocialLogin(context, 'google'), ), // Disable if loading
                           const SizedBox(width: 20),
                           IconButton( icon: const Icon(Icons.apple), iconSize: 40, color: Colors.white, tooltip: 'Sign in with Apple', onPressed: _isLoading ? null : () => _handleSocialLogin(context, 'apple'),), // Disable if loading
                         ],
                       ),
                      const SizedBox(height: 20),
          ...
          Align(
            ...
            child: Padding( /* ... same as before ... */
              padding: const EdgeInsets.only(bottom: 20.0),
              child: Row( mainAxisAlignment: MainAxisAlignment.center, children: [ TextButton( onPressed: () => _handleLinkTap(context, 'Terms'), child: const Text( 'Terms of Service', style: TextStyle(color: Colors.white70, fontSize: 12, decoration: TextDecoration.underline, decorationColor: Colors.white70), ), ), const Text('  |  ', style: TextStyle(color: Colors.white70, fontSize: 12)), TextButton( onPressed: () => _handleLinkTap(context, 'Privacy'), child: const Text( 'Privacy Policy', style: TextStyle(color: Colors.white70, fontSize: 12, decoration: TextDecoration.underline, decorationColor: Colors.white70), ), ), ], ),
            ),
          ),
        ],
      ),
