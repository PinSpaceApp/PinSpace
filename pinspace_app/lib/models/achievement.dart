...
class Achievement {
  ...
  // Removed 'const' from constructor to allow non-constant color shades
  Achievement({
    required this.id,
    required this.name,
...
// Removed 'const' from individual Achievement instantiations
final List<Achievement> allAchievements = [
  // --- Collection Milestones ---
  Achievement(
    id: "collect_first_pin", name: "First Pin Acquired!", description: "Add your very first pin to your collection.",
    iconData: Icons.star_outline, iconColor: Colors.amber, backgroundColor: Colors.amberAccent.shade100, // Use specific shade if needed
